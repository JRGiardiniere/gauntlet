...
> effect@4.0.0-beta.90; gauntlet pins **4.0.0-rc.110** and runs plain Node
...
> the installed beta.106 source** (verified 2026-08-10; the beta.106→rc.110
> changesets touch no API this doc prescribes except CLI boolean semantics,
> re-checked 2026-08-18); the substantive
