...
mkdir -p "$home/.agents/skills" "$legacy_skill"
cp "$release_skill" "$legacy_skill/SKILL.md"
ln -s "$legacy_skill" "$home/.agents/skills/gauntlet"
...
test ! -L "$home/.agents/skills/gauntlet"
cmp "$release_skill" "$home/.agents/skills/gauntlet/SKILL.md"
test -L "$home/.claude/skills/gauntlet"
test "$(readlink "$home/.claude/skills/gauntlet")" = "../../.agents/skills/gauntlet"
cmp "$release_skill" "$home/.claude/skills/gauntlet/SKILL.md"
